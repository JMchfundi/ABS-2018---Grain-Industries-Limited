...
public class GEP_E2J_Bankingsxlsx {
	...
	public static TableModel showExcel2Jtable(String excelFilePath, JTable excelDataTable, JTextField infoTextField) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, e.getMessage(), new GEP_E2J_Bankingsxlsx().getClass().getSimpleName(),
